...
export default function NoteTabs() {
    const { filterNote, tabValue, setTabValue, setIsCreate, isLoading } = useNoteContext();
                    ...
                    >
                        ...
                        {filterNote.map((value: NoteType, index: number) => (
                            <Tab 
                                ...
                                sx={{ fontSize: 13, backgroundColor: filterNote[index].type == "game" ? "orange !important" : "#1976d2 !important", color: "#fff !important" }}
